...
class MainWindow(QMainWindow):
    ...
    def setup_bottom_bar(self, parent_layout):
        ...
        for btn in [self.add_btn, self.ai_btn, self.voice_btn,
                    self.hands_btn, self.face_btn, self.clean_btn]:
    ...
    def toggle_voice_input(self):
        ...
        if not self.is_listening:
            ...
            self.voice_btn.setIcon(QIcon(self.get_svg_icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z")))
